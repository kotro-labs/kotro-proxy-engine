...
if [[ "$CONFIRM" -eq 0 ]]; then
  ...
  echo ""
  echo "  [ ] NPM_TOKEN  — npm automation token for @kortolabs/proxy-engine"
  echo "  [ ] VSCE_PAT   — VS Code Marketplace publish token (publisher: kortolabs)"
  echo ""
...
echo "Monitor: https://github.com/ramairwing/kotro-proxy-engine/actions/workflows/release.yml"
echo ""
