...
if [[ "$CONFIRM" -eq 0 ]]; then
  ...
  echo "  https://github.com/kotro-labs/kotro-proxy-engine/settings/secrets/actions"
  echo ""
...
echo "Monitor: https://github.com/kotro-labs/kotro-proxy-engine/actions/workflows/release.yml"
echo ""
